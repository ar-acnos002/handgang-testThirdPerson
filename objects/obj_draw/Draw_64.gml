...
draw_text(drawX, drawY+64, "Camera Speed X: "+string(obj_camera.cameraSpeedX))
draw_text(drawX, drawY+80, "Camera Speed Y: "+string(obj_camera.cameraSpeedY))
draw_text(drawX, drawY+112, "Camera Radius: "+string(obj_camera.cameraRadius))